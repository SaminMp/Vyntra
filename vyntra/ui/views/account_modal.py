...
class AccountModal(ctk.CTkToplevel):
    ...
    def _build_content(self):
        ...
        self.status_msg.pack(padx=14, pady=(0, 10), anchor="w")

        # 2. Action Buttons
        btn_box = ctk.CTkFrame(self.card, fg_color="transparent")
        btn_box.pack(fill="x", padx=16, pady=(8, 14))
        ...
        sec_box.pack(fill="x", padx=16, pady=(8, 16))

        sec_lbl = ctk.CTkLabel(
            sec_box,
            text=(
                "🔒 Official Google Sign-In:\n"
                "• You authenticate directly through Google in your browser.\n"
                "• Vyntra NEVER sees, captures, or stores your Google password.\n"
                "• Your session stays securely signed in between app restarts."
            ),
            font=Theme.FONT_CAPTION,
    ...
    def _handle_signin(self):
        ...
        self.status_msg.configure(text="Complete sign-in in your browser...")
